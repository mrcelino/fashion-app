...
export type Product = {
  id: string;
  name: string;
  type: "donation" | "rental" | "thrifting";
  description: string;
  size: string;
  color: string;
...
export const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  const stockPercentage =
    (product.available_quantity / product.total_quantity) * 100;
    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-2 mb-3">
          {(product.type === "rental" || product.type === "thrifting") &&
            product.price && (
              <span
          ...
          <div className="flex items-center justify-between gap-3 text-sm text-gray-600 w-full">
            <div className="flex items-center gap-1">
              <div
                ...
                style={{
                  backgroundColor: colorMap[product.color] || product.color,
                }}
              ></div>
