...
export function Sidebar() {
  ...
  return (
    <div className="fixed pt-24 left-0 h-full w-80 p-6 text-black overflow-y-auto bg-white border-r border-gray-200 shadow-lg">
      <nav>
          ...
          {navItems.map(({ href, label, icon }) => {
            ...
            return (
              <li key={href}>
                ...
                >
                  <span
                    className={`absolute inset-0 rounded-xl bg-gray-200 transition-opacity duration-300   ${
