...
const Page: FC = () => {
  ...
  return (
      ...
      <div className='flex flex-row justify-between items-center'>
        ...
        <button className='btn rounded-2xl bg-red-500 text-white cursor-pointer hover:scale-105 transition duration-300'>Hapus Item</button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
        ...
        <div className="flex flex-col gap-y-5">
          ...
          <div className="flex justify-end gap-4">
            <button className="px-6 py-2.5 text-sm font-semibold text-gray-700 bg-gray-100 border border-gray-300 rounded-xl hover:bg-gray-200 transition cursor-pointer">
              Kosongkan Formulir
            </button>
            <button className="px-6 py-2.5 text-sm font-semibold text-white bg-blue-500 rounded-xl hover:bg-blue-600 transition cursor-pointer">
              Simpan Barang
            </button>
          </div>
        </div>
